    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-success">
                Applicants' Profile  <button id='printButton' class="btn btn-success" onclick='printTable()'>Print List Of ALL  Applicants</button>
            </div> 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                    $s_query = $conn->query("SELECT * FROM `applicants` ORDER BY `time` DESC") or die(mysqli_error($conn));
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $s_fetch['bursary_title']?></td>
                                        <td><?php echo $s_fetch['bank']?></td>
                                        <td><?php echo $s_fetch['amount']?></td>
                                        <td><?php echo $s_fetch['time']?></td>
