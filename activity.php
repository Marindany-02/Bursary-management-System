           ...
           <!--  <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type = "button" id = "add_activity" class = "btn btn-success"><span class = "glyphicon glyphicon-plus"></span> Upload Task</button>
                    ...
                    <div  id = "act_table" class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                $act_query = $conn->query("SELECT * FROM `activity` WHERE `admin_id` = '$_SESSION[admin_id]' ") or die(mysqli_error($conn));
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                           <a href = "edit_activity.php?activity_id=<?php echo $act_fetch['activity_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> <a href = "#" data-toggle = "modal" data-target = "#delete_activity" name = "<?php echo $act_fetch['activity_id']?>" class = "btn btn-danger activity_id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a>
                                        </td>
                                    </tr>
                                <?php
                                    }
                ...
                <div id = "act_form" style = "display:none;" class = "panel panel-default">
                    <div  class = " panel-heading" >    
                        <div class = "alert alert-success">add task/ new</div>
