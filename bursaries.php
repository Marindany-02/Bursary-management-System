                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                           ...
                                           <a href = "edit_bursary.php?activity_id=<?php echo $act_fetch['activity_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> 

                                           <a href = "#" data-toggle = "modal" data-target = "#delete_activity" name = "<?php echo $act_fetch['activity_id']?>" class = "btn btn-danger activity_id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a>
                                        </td>
                                    </tr>
                                <?php
                                    }
